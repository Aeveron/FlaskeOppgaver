...
namespace FlaskeOppgaver
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //var bottle1Length = args[0];
            var bottle2 = new TestBottle(7);
            //var bottle2Length = args[1];
            var wantedVolume = 1;
            //var wantedVolumeLength = args[2];
        ...
        private static bool TryWithGivenNumberOfOperations(int numberOfOperations, TestBottle bottle1, TestBottle bottle2, int wantedVolume)
        {
        ...
        private static bool IsSolved(TestBottle bottle1, TestBottle bottle2, int wantedVolume, int[] operations)
        {
        ...
        private static void DoOperations(int[] operations, TestBottle bottle1, TestBottle bottle2)
        {
            bottle1.Empty();
            bottle2.Empty();
